                ...
                case message_types_1.default.GQL_START:
                    connectionContext.initPromise.then(function (initResult) {
                        ...
                        promisedParams.then(function (params) {
                            return ((_this.schema instanceof graphql_1.GraphQLSchema) ?
                                Promise.resolve(_this.schema) :
                                Promise.resolve(_this.schema(connectionContext, params)))
                                .then(function (schema) { return [params, schema]; });
                        }).then(function (_a) {
                            var params = _a[0], schema = _a[1];
                            ...
                            var validationErrors = graphql_1.validate(schema, document, _this.specifiedRules);
                            if (validationErrors.length > 0) {
                                ...
                                var promiseOrIterable = executor(schema, document, _this.rootValue, params.context, params.variables, params.operationName);
